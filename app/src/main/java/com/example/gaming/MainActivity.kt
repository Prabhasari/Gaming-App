...
class MainActivity : AppCompatActivity() {
    ...
    private val brickRows = 15

    private val brickColumns = 13
    ...
    private fun initializeBricks() {
        ...
        for (row in 0 until brickRows) {
            ...
            for (col in 0 until brickColumns) {
                ...
                when ((row + col) % 4) {
                    0 -> brick.setBackgroundResource(R.drawable.brick_blue) // Blue color
                    1 -> brick.setBackgroundResource(R.drawable.brick_green) // Green color
                    2 -> brick.setBackgroundResource(R.drawable.brick_red) // Red color
                    3 -> brick.setBackgroundResource(R.drawable.brick_yellow) // Yellow color
                }
    ...
    private fun gameOver() {
        ...
        // Retrieve the highest score from shared preferences
        ...
        // Pass both scores to ScoreActivity
        val intent = Intent(this, ScoreActivity::class.java)
        intent.putExtra("SCORE", score)
        intent.putExtra("HIGH_SCORE", highestScore)
